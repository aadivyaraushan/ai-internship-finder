...
const promptTemplate = new PromptTemplate({
    template: `You are an AI assistant with access to the user's resume data. Use this context to provide personalized responses.
...
export const POST = async (req: Request) => {
    try {
        ...
        const resumeContext = memoryVariables.resume_context || "No resume data available";
